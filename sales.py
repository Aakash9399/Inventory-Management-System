...
class salesClass:
    def __init__(self,root):
        ...
        lbl_invoice=Label(self.root,text="Invoice No. ",font=("times new roman",15),fg="black",bg="white").place(x=50,y=100)
        txt_invoice=Entry(self.root,textvariable=self.var_invoice,font=("times new roman",15),fg="black",bg="lightyellow").place(x=150,y=100,width=180,height=28)
