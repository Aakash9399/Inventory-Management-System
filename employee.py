...
class employeeClass:
    def __init__(self,root):
        ...
        # ==== search frame ===
        SearchFrame=LabelFrame(self.root,text="Search Employee", font=("goudy old style",12,"bold"),bd=2,relief=RIDGE,bg="blue")
        ...
        #===content====
        #row1
        lbl_empid=Label(self.root,text="Emp ID",font=("goudy olfd style",15),bg="white").place(x=50,y=150)
        lbl_gender=Label(self.root,text="Gender",font=("goudy olfd style",15),bg="white").place(x=350,y=150)
        lbl_contact=Label(self.root,text="Contact",font=("goudy olfd style",15),bg="white").place(x=750,y=150)
        ...
        #row 2
        lbl_name=Label(self.root,text="Name",font=("goudy olfd style",15),bg="white").place(x=50,y=190)
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy olfd style",15),bg="white").place(x=350,y=190)
        lbl_doj=Label(self.root,text="D.O.J",font=("goudy olfd style",15),bg="white").place(x=750,y=190)
        ...
        txt_doj=Entry(self.root,textvariable=self.var_doj,font=("goudy olfd style",15),bg="lightyellow").place(x=850,y=190,width=180)
        #row3
         
        
        lbl_email=Label(self.root,text="Email",font=("goudy olfd style",15),bg="white").place(x=50,y=230)
        lbl_pass=Label(self.root,text="Password",font=("goudy olfd style",15),bg="white").place(x=350,y=230)
        lbl_utype=Label(self.root,text="User type",font=("goudy olfd style",15),bg="white").place(x=750,y=230)
        ...
        lbl_address=Label(self.root,text="Address",font=("goudy olfd style",15),bg="white").place(x=50,y=270)
        lbl_salary=Label(self.root,text="Salary",font=("goudy olfd style",15),bg="white").place(x=500,y=270)
